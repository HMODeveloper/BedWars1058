...
public class ConfigPath {
    ...
    public static final String GENERATOR_ENABLE_GEN_SPLIT = "enable-gen-split";
    public static final String GENERATOR_GEN_SPLIT_RADIUS = "gen-split-radius";
    ...
    public static final String GENERAL_CONFIGURATION_ENABLE_READY_CHECK = "enable-ready-check";
    ...
    public static final String GENERAL_IRON_GOLEM_DAMAGE = "iron-golem.damage";
