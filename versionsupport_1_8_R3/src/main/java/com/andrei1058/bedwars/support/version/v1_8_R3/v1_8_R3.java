...
public class v1_8_R3 extends VersionSupport {
    ...
    public void playInvisibilityParticles(Player target, List<Player> observers, int particleAmount, boolean footstepMode) {
        ...
        if (footstepMode) {
            ...
            loc = target.getLocation().add(0, 0.01, 0);
            particlePacket = new PacketPlayOutWorldParticles(EnumParticle.FOOTSTEP, true,
            ...
            // Base location: slightly above head
            loc = target.getLocation().add(0, 2.2, 0);
            particlePacket = new PacketPlayOutWorldParticles(EnumParticle.REDSTONE, true,
